...
class ConfigDialog(QDialog):
    def __init__(self):
        ...
        self.ui.dateEdit_inicio.setDate(self.config.semester_start)
        self.ui.dateEdit_fim.setDate(self.config.semester_end)
        ...
        self.ui.dateEdit_inicio.dateChanged.connect(partial(self.alterar_config, 'semester_start', self.ui.dateEdit_inicio))
        self.ui.dateEdit_fim.dateChanged.connect(partial(self.alterar_config, 'semester_end', self.ui.dateEdit_fim))
    ...
    def alterar_config(self, name, comp, *args):
