...
from kivy.properties import NumericProperty, ReferenceListProperty, Property, StringProperty
...
class DatePicker(TextInput):
    ...
    def init_ui(self):
        print(self.initial)
        self.text = self.initial or today_date()
        # Calendar
    ...
    def update_value(self, inst):
        ...
        self.text = "%02d/%02d/%s" % tuple(self.cal.active_date)
        self.focus = False
